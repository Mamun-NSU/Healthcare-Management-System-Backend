package com.healthcareapp.pharmaceuticalinventorymanagementservice.utils;
import com.healthcareapp.pharmaceuticalinventorymanagementservice.constants.AppConstants;
import com.healthcareapp.pharmaceuticalinventorymanagementservice.enums.Role;
...
public class JWTUtils {
    ...
    public static String generateToken(String id, Role role){
        return Jwts.builder()
                .setSubject(id)
                .claim("roles", role)
